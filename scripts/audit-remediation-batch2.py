"""Read-only Issue #22 audit; same length/wording heuristics as Batch 1.

Export the pre-change e462e18:index.html to a UTF-8 file, then run:
...
IDS = sorted([11, 15, 20, 24, 80, 81, 90, 91, 111, 120, 121, 130, 131, 150, 151,
              25, 49, 52, 54, 176, 180, 184, 185, 187, 190, 194, 198, 199, 201,
              208, 212, 213, 218, 226, 227, 56, 61, 63, 66, 266, 270, 271, 277,
              279, 281, 282, 288, 290, 292, 293, 303, 304, 310, 312, 314, 315,
              321, 323, 325, 326])
